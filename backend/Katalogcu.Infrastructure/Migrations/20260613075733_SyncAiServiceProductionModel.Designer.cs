...
namespace Katalogcu.Infrastructure.Migrations
{
    ...
    [Migration("20260613075733_SyncAiServiceProductionModel")]
    partial class SyncAiServiceProductionModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Katalogcu.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<int>("PasswordResetFailedCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("Katalogcu.Domain.Entities.MachineModel", b =>
                {
                    ...
                    b.HasIndex("Brand", "Model", "Variant")
                        .IsUnique();
            ...
            modelBuilder.Entity("Katalogcu.Domain.Entities.PartCompatibilityRule", b =>
                {
                    ...
                    b.HasIndex("CatalogItemId", "MachineModelId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Katalogcu.Domain.Entities.RegistrationInviteCode", b =>
                {
                    ...
                    b.HasIndex("RevokedAt", "UsedAt", "ExpiresAt");
