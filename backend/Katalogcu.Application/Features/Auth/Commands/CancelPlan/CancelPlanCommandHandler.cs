...
public sealed class CancelPlanCommandHandler : IRequestHandler<CancelPlanCommand, OperationResult<AuthUserDto>>
{
    private readonly ICurrentUserService _currentUser;
    private readonly IAuthRepository _authRepository;

    public CancelPlanCommandHandler(ICurrentUserService currentUser, IAuthRepository authRepository)
    {
        _currentUser = currentUser;
        _authRepository = authRepository;
    }

    public async Task<OperationResult<AuthUserDto>> Handle(CancelPlanCommand request, CancellationToken cancellationToken)
    {
        ...
        user.SubscriptionPlan = SubscriptionPlan.CatalogOnly;
